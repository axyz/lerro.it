...
<title>Protection of Minors and Non Compos Mentis - Law Firm - Rome</title></head>
<body><?php } else { ?>
<title>Protezione Degli Incapaci - Studio Legale - Lerro&amp;Partners - Roma</title></head>
...
<div id="content" class="row">
  <div class="eleven columns centered">
	...
	<div class="four columns">	
	  <ul class="side-nav">
	    <li> <a href="attivita-commerciale-societario.php?lang=en">CORPORATE AND COMMERCIAL</a></li>
	    <li> <a href="attivita-ma-management-buy-out-venture-capital.php?lang=en">M&A, VENTURE CAPITAL, M.B.O.</a></li>
	    <li> <a href="attivita-proprieta-intellettuale-concorrenza.php?lang=en">INTELLECTUAL PROPERTY AND COMPETITION</a></li>
	    <li> <a href="attivita-internet-new-media.php?lang=en">INTERNET AND NEW MEDIA</a></li>
	    <li> <a href="attivita-proprieta-immobiliare.php?lang=en">REAL ESTATE PROPERTY</a></li>
	    <li> <a href="attivita-gestioni-patrimoniali-trust-successioni.php?lang=en">HERITAGE, TRUSTS, SUCCESSION</a></li>
	    <li> <a href="attivita-contenzioso-arbitrato.php?lang=en">LITIGATION AND ARBITRATION</a></li>
	    <li> <a href="attivita-energia.php?lang=en">ENERGY</a></li>
	    <li> <a href="attivita-amministrazione-sostegno-tutela-protezione-incapaci.php?lang=en">PROTECTION OF MINORS AND NON COMPOS MENTIS</a></li>
	  </ul>
	</div>
<?php } else { ?>
	<div class="four columns">	
