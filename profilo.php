...
<title>Profile - Law Firm - Rome</title></head>
<body><?php } else { ?>
<title>Profilo Aziendale - Studio Legale - Lerro&amp;Partners - Roma</title></head>
...
<div id="content" class="row">
  <div class="eleven columns centered">
    <div class="twelve columns panel box-fluid"><?php if($_GET['lang'] == "en") { ?>
      <p>Lerro&Partners is a law firm based in Rome and maintains stable relationships with accomplished professionals in Italy and Europe, in order to offer the client maximum national and foreign coverage thereby facilitating cost optimization. Italian and English are the working languages ​​of our practice, which has always had a strong international vocation.</p>
      <p>Lerro&Partners relies on the more than twenty years of experience of the senior partner, who after ten years of working with major firms has created his own professional structure, enriched by his significant experience in representing well-known private as well as multinational clients.</p>
      <p>Our strengths are our strategic perspective, highly technical skills, speed and efficiency in the management of assignments and the ability to communicate with professionals in several fields other than legal; these characteristics have led to the development of high strategic and negotiation skills in different areas of activity.</p>
      <p>In addition to substantial extra-judicial and negotiation activities, Lerro&Partners attends to litigation before ordinary instances, arbitration and before the High Courts and the Court of Justice of the European Union.</p>
      <p>Experience has shown that, regardless of the economic importance or the legal difficulty, a legal issue can seriously affect the life of the client.</p>
      <p>Therefore, our approach is proactive and of outstanding quality, in order to achieve a perfect understanding of the client’s needs with calm, empathy, honesty and clarity discussing all aspects of the case, to identify clear and shared solutions even where it seems impossible.</p><?php } else { ?>
